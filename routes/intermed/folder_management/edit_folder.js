...
const { directus_retrieve_user, directus_list_folders } = require('../../../config/global_functions');
const router = express.Router();

const urlapi = getDirectusUrl();
const moment = getMoment();

const SERVICE_TYPE = "admin_folder_list"
...
router.get('/', async function (req, res, next) {
  ...
  let folders = []
  let r_dts_folders = await directus_list_folders(filters)
